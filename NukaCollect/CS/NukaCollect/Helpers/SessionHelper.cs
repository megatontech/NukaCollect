...
namespace NukaCollect.Helpers
{
    ...
    {
        private const string xpoPrefix = "DevExpress.Xpo.";
        private static string[] xpoServicesClasses = new string[] { "PersistentBase", "XPBaseObject", "XPObjectType" };
        ...
        private static object GetObjectByKeyCore(Type classType, object objectKey, Session session)
        {
        ...
        private static Dictionary<IXPSimpleObject, bool> GetObjectsForCopy(Session session, XPClassInfo[] classes)
        {
