...
namespace NukaCollect
{
    public class RentsHistory
    {
        ...
        private abstract class RandomGenerator
        {
        ...
        private abstract class RandomGeneratorNoRepetitions : RandomGenerator
        {
            public abstract void ClearRepetitions();
        }

        private class RandomGeneratorFiveState : RandomGenerator
        {
            private int zero, one, two, three, four, min, max;
        ...
        private class RandomGeneratorFlat : RandomGenerator
        {
            private int min;
            private int max;
        ...
        private class RandomGeneratorGauss : RandomGenerator
        {
            private double aver;
        ...
        private abstract class RandomGeneratorSimpleNoRepetitions : RandomGeneratorNoRepetitions
        {
            private Dictionary<int, bool> repetitions = new Dictionary<int, bool>();
            ...
            public override void ClearRepetitions()
            {
                repetitions.Clear();
            }
            ...
            public override int GetMin()
            {
                return generator.GetMin();
            }

            protected RandomGenerator Generator { get { return generator; } }
        }

        private class RandomGeneratorFlatNoRepetitions : RandomGeneratorSimpleNoRepetitions
        {
            ...
            public static RandomGeneratorFlatNoRepetitions MinMax(int min, int max)
            {
                return new RandomGeneratorFlatNoRepetitions(true, min, max);
            }
        }

        private class RandomGeneratorGaussNoRepetitions : RandomGeneratorSimpleNoRepetitions
        {
        ...
        private class MovieData
        {
            ...
            private MovieItemData GetActiveItem(MovieItemFormat format)
            {
            ...
            private void ChangeItemStatus(MovieItemData item, MovieItemStatus oldStatus, MovieItemStatus newStatus)
            {
        ...
        private Dictionary<MovieItemFormat, decimal> sellingPrices = new Dictionary<MovieItemFormat, decimal>();
        private UnitOfWork session;
        private CustomerData[] customers;
        private MovieData[] movies;
        private int daysCount;
        private RandomGeneratorNoRepetitions movieGenerator;
        private RandomGenerator lostDamageTimeGenerator;
        private List<LostDamageItemAction> lostDamageItemActions = new List<LostDamageItemAction>();
        private Dictionary<int, int> moviesMap = new Dictionary<int, int>();
        private static MovieItemFormat[] formats = EnumHelper.GetValues<MovieItemFormat>();
        private static MovieItemStatus[] statuses = EnumHelper.GetValues<MovieItemStatus>();
        private static Dictionary<MovieItemFormat, int> formatsIndexes;
        private static Dictionary<MovieItemStatus, int> statusesIndexes;
        private RandomGenerator[] addedItemsCountGenerators;
        private IBackgroundWorker backgroundWorker;
        private IExceptionProcesser exceptionProcesser;
        ...
        private void SetDefaultCategoryPrices()
        {
        ...
        private void CreateCutPriceCategory()
        {
        ...
        private void CreateNewReleasesCategory()
        {
        ...
        private void GenerateAddedItemsCounts()
        {
        ...
        private void GenerateMoviesData()
        {
        ...
        private void GenerateCustomersData()
        {
        ...
        private void GenerateLostDamageItemActions()
        {
        ...
        private void GenerateSell(CustomerData customer, Point point)
        {
        ...
        private void GenerateRentsAndSells()
        {
            foreach (CustomerData customer in customers)
            {
