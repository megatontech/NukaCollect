...
namespace NukaCollect
{
    ...
    public class IniFile
    {
        ...
        private void AddRawValue(string key, string value)
        {
            key = key.Trim();
            value = value.Trim();
    ...
    {
        private const string DBFormatKey = "[]DBFormat";
        private const string MdbPathKey = "[]MdbPath";
        private const string SqlDBNameKey = "[]SqlDbName";
        private const string ServerKey = "[]Server";
        private const string SqlAuthenticationTypeKey = "[]SqlAuthenticationType";
        ...
        {
            return sqlDBHandle.ConnectionString;
        }
    ...
    public class InitialDbCreator
    {
        ...
        private ICreateInitialDbDialog createInitialDbDialog;
        private bool operationsInProgress = false;
        private bool operationsComplete = false;
        private UnitOfWork session;
        private IniFile iniFile;
        private DBConnectData dbConnectData;
        private bool unableToCreateDb = false;
        ...
        private void CreateInitialDbDialog_Start(object sender, EventArgs e)
        {
        ...
        private void EndOperations(bool complete)
        {
        ...
        private string TryOpenMdb(bool deleteExist, bool tryCreateNew, out bool createNew)
        {
        ...
        private string TryOpenSql(bool deleteExist, bool tryCreateNew, out bool createNew)
        {
            string connectionString = null;
            createNew = false;
        ...
        private UnitOfWork OpenDb(bool deleteExist, bool tryCreateNew)
        {
        ...
        private void CreateDbWorker_DoWork(object sender, DoWorkEventArgs e)
        {
        ...
        private void CreateDbWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (unableToCreateDb)
            {
                EndOperations(false);
        ...
        private void GenerateRentsHistoryWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            session.Dispose();
            EndOperations(true);
            createInitialDbDialog.Close();
        ...
        private void CorrectCustomersBirthDate(UnitOfWork session)
        {
