...
namespace NukaCollect
{
    public class InitialRecords
    {
        ...
        private static void CheckForDefaultAdministrator(Session session)
        {
        ...
        private static void CheckForDefaultCategories(Session session)
        {
        ...
        private static void CheckForDirectorLine(Session session)
        {
            if (MovieArtistLine.GetDirector(session) != null) return;
            new MovieArtistLine(session, ReferenceData.DirectorString);
        }

        private static void CheckForCompanyTypes(Session session)
        {
        ...
        private static void CheckForMovieLanguages(Session session)
        {
    ...
    public class VideoRentCurrentUser
    {
        ...
        private static Guid currentUserOid = Guid.Empty;
