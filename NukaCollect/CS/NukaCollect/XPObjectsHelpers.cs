...
namespace NukaCollect.Helpers
{
    ...
    {
        private static DateTime debugNow;
    ...
    public class IDGenerator : VideoRentBaseObject
    {
        ...
        private static Session fastGeneratorSession = null;
        private static Dictionary<string, int> lastGeneratedIds = new Dictionary<string, int>();
        private static Session disableGeneratorSession = null;
        ...
        private static int GenerateIdFast(string type, int requiredId)
        {
        ...
        private static int GenerateIdSlow(Session session, string type, int requiredId)
        {
