...
namespace NukaCollect.Reports
{
    ...
    {
        private const string parameterName = "showModeParameter";
        ...
        private void CustomerFilmRentsListReport_ParametersRequestBeforeShow(object sender, ParametersRequestEventArgs e)
        {
        ...
        private ImageComboBoxEdit CreateShowModeEditor(Array values, string[] names)
        {
        ...
        private void xrPictureBoxCustomerPhoto_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void xrTableCellReturnedOn_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
