...
namespace NukaCollect.Win.Modules
{
    public partial class Movies : GridExportTutorialControl
    {
        ...
        private int downRowHandle = -1;
        private int hotRowHandle = -1;

        private int DownRowHandle
        {
        ...
        private bool IsButtonColumn(GridColumn column)
        {
        ...
        private void LinkButtonClick(Movie movie)
        {
        ...
        private string GetCardFilterValue(string filter)
        {
        ...
        private NukaCollect.Movie GetCurrentKey(object row)
        {
