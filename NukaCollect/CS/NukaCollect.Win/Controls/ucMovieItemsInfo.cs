...
namespace NukaCollect.Win.Controls
{
    public partial class ucMovieItemsInfo : XtraUserControl
    {
        ...
        private MovieItemFormat?[] formatsAndAll;
        private bool lockInit = false;
        ...
        private Series FormatSeries
        { get { return ccFormatsInfo.Series[0]; } }
        private Series RentalSalesInfoSeries
        { get { return ccFormatsInfo.Series[1]; } }
        ...
        private ucRentalSalesInfo GetCurrentRentalSalesInfo(string caption)
        {
        ...
        private void InitFormatSeries(MovieItemFormat[] formats)
        {
        ...
        private void InitRentalSalesInfoSeries(MovieItemFormat? format)
        {
        ...
        private void ExplodeFormatSeries(MovieItemFormat? format)
        {
        ...
        private void ccFormatsInfo_PieSeriesPointExploded(object sender, PieSeriesPointExplodedEventArgs e)
        {
        ...
        private void UpdateFormatSeries()
        {
            if (lockInit) return;
