...
namespace NukaCollect.Win
{
    ...
    public class FormLayoutInfo
    {
        ...
        private ColumnView alternateView;
        private RibbonQuickAccessToolbar toolbar;
    ...
    public class FormLayoutManager
    {
        ...
        private UnitOfWork dataSession;
        private WinFormProperties properties;
        private SetCustomerInfoDelegate setCustomerInfo;
        ...
        private void RaiseCurrentCustomerChanged()
        {
        ...
        private void SetCustomerExample()
        {
        ...
        private bool MoveCustomer(bool prev)
        {
    ...
    public class WinFormProperties
    {
        ...
        private void SaveChartAppearences(ChartAppearanceManager chartManager)
        {
        ...
        private void SaveCurrentCustomer(FormLayoutManager manager)
        {
            CurrentProperty.CurrentCustomerId = manager.CurrentCustomer == null ? Guid.Empty : manager.CurrentCustomer.Oid;
        }

        private void SaveNavPaneState(NavPaneState state)
        {
    ...
    {
        private static Period receiptPeriod, kpiPeriod;
