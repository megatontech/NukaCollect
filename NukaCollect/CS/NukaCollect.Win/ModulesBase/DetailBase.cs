...
namespace NukaCollect.Win.Modules
{
    public partial class DetailBase : XtraUserControl, IFormWithLayoutManager
    {
        ...
        private GetSessionCallback externalSession;
        private UnitOfWork session;
        private Form parent;
        private bool dirty = false;
        private bool createNewObject = false;
        private CloseDetailForm closeForm = null;
        private DialogResult returnResult = DialogResult.Cancel;
        ...
        private static bool IsEmpty(RibbonPageGroup group)
        {
            foreach (BarButtonItemLink link in group.ItemLinks)
        ...
        private static void UpdateItemLinks(RibbonPageGroup group, bool ReadOnly)
        {
            foreach (BarButtonItemLink link in group.ItemLinks)
        ...
        private bool showCloseDialog = true;
