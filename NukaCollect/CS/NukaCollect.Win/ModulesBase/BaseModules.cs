...
namespace NukaCollect.Win
{
    ...
    public class ModuleInfo
    {
        ...
        private TutorialControlBase module;
        private DemoProducts products = DemoProducts.None;
    ...
    public class ModulesInfo
    {
        ...
        public static ModuleInfo GetItem(string name)
        {
    ...
    {
        private TutorialControlBase owner;
        ...
        private DetailBase IsDetailExist(DetailBase value)
        {
    ...
    public class TutorialControlBase : XtraUserControl
    {
        ...
        private DetailModulesCollection detailModuleCollection = null;
        ...
        private DetailBase activeDetailControl = null;
        ...
        private static bool RibbonPageHeaderItemLinkCollectionContainsBarItem(BarButtonItem item, RibbonPageHeaderItemLinkCollection collection)
        {
        ...
        private void AddManager(ControlCollection collection, IDXMenuManager manager)
        {
